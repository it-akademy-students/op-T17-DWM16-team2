 ...
 */
final class Version20211215103248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, movie_id INT NOT NULL, reference VARCHAR(255) NOT NULL, stripe_token VARCHAR(255) NOT NULL, brand_stripe VARCHAR(255) NOT NULL, last4_stripe INT NOT NULL, id_charge_stripe VARCHAR(255) NOT NULL, status_stripe VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_F5299398A76ED395 (user_id), INDEX IDX_F52993988F93B6FC (movie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
